...
class FinalizedTables extends Component {
    constructor(props) {
        super(props);
    }
    ...
    renderRows() {
        return this.props.tables_finalized.map(table=> {
            return (
                <Table.Row 
                ...
                >
                    ...
                    <Table.Cell>{`${table.finalized.manager.firstName} ${table.finalized.manager.lastName}`}</Table.Cell>
                </Table.Row>
            )
        });
    }
            ...
            <Table celled selectable padded>
                <Table.Header>
                    <Table.Row>
                        ...
                        <Table.HeaderCell>Finalized By</Table.HeaderCell>
                    </Table.Row>
                </Table.Header>
                <Table.Body>
                {this.renderRows()}
...
export default FinalizedTables;